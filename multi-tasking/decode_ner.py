...
infile_path = "/home/sakakini/adr-detection-parent/large-files/datasets/ADE/ADE_NER_All.txt"
latent_dim = 400
batch_size = 1000
epochs = 10
...
bidirectional_model = load_model("bi_ner.h5")
prediction_model = load_model("dense_ner.h5")
